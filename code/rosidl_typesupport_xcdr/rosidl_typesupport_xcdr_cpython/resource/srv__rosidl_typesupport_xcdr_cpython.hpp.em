@# generated from rosidl_typesupport_xcdr_cpython/resource/srv__rosidl_typesupport_xcdr_cpython.hpp.em
@{
...
# For C symbol names, use a single token (e.g., 'srv_experimental').
...
header_guard_body = '__'.join(
    [x.upper() for x in include_parts + ['rosidl_typesupport_xcdr_cpython']]) + '_HPP_'
}@
