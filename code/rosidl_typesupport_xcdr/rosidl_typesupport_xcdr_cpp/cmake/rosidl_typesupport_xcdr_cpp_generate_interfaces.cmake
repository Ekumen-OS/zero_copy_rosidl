...
set(generator_arguments_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_xcdr_cpp__arguments.json")
rosidl_write_generator_arguments(
  ...
  TEMPLATE_DIR "${rosidl_typesupport_xcdr_cpp_TEMPLATE_DIR}"
...
add_custom_command(
  ...
  ARGS ${rosidl_typesupport_xcdr_cpp_BIN}
  --generator-arguments-file "${generator_arguments_file}"
  DEPENDS ${target_dependencies}
  COMMENT "Generating C++ XCDR typesupport"
  VERBATIM
  ${_dep_explicit_only}
)
...
set(_visibility_control_file
  "${_output_path}/msg/rosidl_typesupport_xcdr_cpp__visibility_control.h")
string(TOUPPER "${PROJECT_NAME}" PROJECT_NAME_UPPER)
configure_file(
  "${rosidl_typesupport_xcdr_cpp_TEMPLATE_DIR}/rosidl_typesupport_xcdr_cpp__visibility_control.h.in"
  "${_visibility_control_file}"
  @ONLY
)

set(_target_suffix "__rosidl_typesupport_xcdr_cpp")

# Create a library that builds the generated files
add_library(${rosidl_generate_interfaces_TARGET}${_target_suffix} ${rosidl_typesupport_xcdr_cpp_LIBRARY_TYPE}
  ${_generated_files})
...
set_target_properties(${rosidl_generate_interfaces_TARGET}${_target_suffix}
  PROPERTIES
    DEFINE_SYMBOL "ROSIDL_TYPESUPPORT_XCDR_CPP_BUILDING_DLL_${PROJECT_NAME}"
    CXX_STANDARD 17)
...
target_include_directories(${rosidl_generate_interfaces_TARGET}${_target_suffix}
  PUBLIC
  "$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/rosidl_typesupport_xcdr_cpp>"
...
if(NOT rosidl_generate_interfaces_SKIP_INSTALL)
  ...
  ament_export_dependencies(rosidl_typesupport_xcdr_cpp)
...
if(BUILD_TESTING AND rosidl_generate_interfaces_ADD_LINTER_TESTS)
  ...
  ament_cppcheck(
    TESTNAME "cppcheck_rosidl_typesupport_xcdr_cpp"
    ${_generated_files})

  find_package(ament_cmake_cpplint REQUIRED)
  get_filename_component(_cpplint_root "${_output_path}" DIRECTORY)
  ament_cpplint(
    TESTNAME "cpplint_rosidl_typesupport_xcdr_cpp"
    MAX_LINE_LENGTH 999
    ROOT "${_cpplint_root}"
    ${_generated_files})
  ...
  ament_uncrustify(
    TESTNAME "uncrustify_rosidl_typesupport_xcdr_cpp"
    MAX_LINE_LENGTH 0
    ${_generated_files})
endif()
