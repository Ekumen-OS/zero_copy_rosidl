// generated from rosidl_generator_cpp/resource/idl__experimental.hpp.em
// generated code does not contain a copyright notice

@#######################################################################
@# EmPy template for generating experimental/<idl>.hpp facade files
@#
@# Context:
@#  - package_name (string)
...
include_parts = [package_name] + list(interface_path.parents[0].parts) + \
    ['experimental', convert_camel_case_to_lower_case_underscore(interface_path.stem)]
